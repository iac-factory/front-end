...
export module Component {
    ...
    const Source = ( icon?: Icon.Type ) => {
        icon = String( icon ).toLowerCase() as Icon.Type;
                    ...
                    ( Array.isArray( properties.items ) )
                        ? properties.items.map(
                            ( component, index, array ) => {
                                const SVG = () => Source( component.icon ?? component.title as Icon.Type );

                                return (
                                    <li key={ [ properties.name, "list-item", index ].join( "-" ) } className={ styles.list }>
                                        <div className={ styles.icon }>
                                            <SVG/>
                                            <Link title={ component.title } url={component.link}/>
                                        </div>
                                    </li>
                                );
                            }
